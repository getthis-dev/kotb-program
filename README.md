...
| Mainnet  | `75LonRXVLyBZbwdKXS3yqoeZUAeeDbsZHnG8Ut3gbhew` |
...
|----------------------|---------|--------------------------------------|
| `slots_to_win`       | 150     | Blocks to win (~1 min)               |
| `fee_bps`            | 1000    | 10% platform fee                     |
| `pot_bps`            | 5000    | 50% to current pot                   |
| `next_bps`           | 4000    | 40% to next round pot                |
| `bid_value_rate_bps` | 100     | 1% bid increase rate                 |
| `vault_min_lamports` | 1000000 | Minimum vault balance (0.001 SOL)    |
